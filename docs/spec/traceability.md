...
|---|---|---|:---:|---|---|---|---|
| TASK-001 | 初始化 Next.js 开发环境与 Drizzle ORM Schema | `constitution.md` | 待开始 | — | — | — | — |
| TASK-002 | 数据库连接客户端与 Schema 结构推送 | `design.md` | 待开始 | — | — | — | — |
| TASK-003 | NextAuth.js 配置与轻量邮箱登录/注册 | REQ-001 / AC-001 | 待开始 | — | — | — | — |
