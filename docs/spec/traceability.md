...
| TASK-007R   | 重构 validator 外置 phase4-suspense-check    | REQ-005                                |  done  | `lib/writer/validator.ts`                                                                                                                                                                                         | `lib/writer/validator.test.ts`                                      | `docs/spec/ac/TASK-007R-AC.md`   | 2026-05-29 |
...
| TASK-008R   | 重构 generator 对齐 Phase 3 外置 Prompt      | REQ-004, REQ-005                       |  done  | `lib/writer/generator.ts`, `lib/writer/chapter-prompt.ts`                                                                                                                                                         | `lib/writer/generator.test.ts`, `lib/writer/chapter-prompt.test.ts` | `docs/spec/ac/TASK-008R-AC.md`   | 2026-05-29 |
...
| 2026-05-29 | 新增 TASK-007R/008R 完成记录 | STEP 6 执行 Module 2.5 收尾 |
