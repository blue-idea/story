...
| TASK-004 | 认证拦截中间件与多租户隔离                   | REQ-001 / AC-001                       | 待开始 | —                                                                                                                                                                                                                 | —                                                       | —                             | —          |
| TASK-005 | 编写 LLM 客户端适配器 (lib/llm.ts)           | `design.md`                            | 待开始 | —                                                                                                                                                                                                                 | —                                                       | —                             | —          |
| TASK-006 | 编写大纲规划与人设生成解析逻辑               | REQ-002/AC-002, REQ-003/AC-001         | 待开始 | —                                                                                                                                                                                                                 | —                                                       | —                             | —          |
| TASK-007 | 编写字数与悬念质量校验模块                   | REQ-005 / AC-001                       | 待开始 | —                                                                                                                                                                                                                 | —                                                       | —                             | —          |
| TASK-008 | 编写串行写作状态机                           | REQ-004/AC-002, REQ-005/AC-002, AC-003 | 待开始 | —                                                                                                                                                                                                                 | —                                                       | —                             | —          |
| TASK-009 | 实现 /api/preferences 偏好与项目检测接口     | REQ-001 / AC-002                       | 待开始 | —                                                                                                                                                                                                                 | —                                                       | —                             | —          |
